...
const LoginForm = () => {
    ...
    return (
        <>
            <section id='login-container' className='justify-center items-center h-screen'>
                <div className="card bg-glassmorphism">
                    <div ref={front} className="face front">
                        ...
                        <div className="right-face">
                            <p className='font-bebas text-5xl'>Login</p>
                    ...
                    <div ref={back} className="face back">
                        ...
                        <div className="right-face">
                            <p className='font-bebas text-5xl'>Register</p>
                            <form id="registeration-form" onSubmit={(e) => RegistrationFunc(e)}>
